...
const Header = () => {
  const { language, setLanguage } = useIELTSStore();
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <input
                type="text"
                placeholder="Search for skills courses, or school"
          ...
          <nav className="hidden lg:flex items-center space-x-6">
            <div className="flex items-center space-x-1 text-gray-700 hover:text-green-600 cursor-pointer">
              <span className="text-sm">Classes 6-12</span>
            ...
            <a href="#" className="text-sm text-gray-700 hover:text-green-600 transition-colors">Admission test</a>
            <div className="flex items-center space-x-1 text-gray-700 hover:text-green-600 cursor-pointer">
              <span className="text-sm">Online Batch</span>
              <ChevronDown className="w-4 h-4" />
            </div>
            <div className="flex items-center space-x-1 text-gray-700 hover:text-green-600 cursor-pointer">
              <span className="text-sm">English Center</span>
              <ChevronDown className="w-4 h-4" />
            </div>
            <div className="flex items-center space-x-1 text-gray-700 hover:text-green-600 cursor-pointer">
          ...
          <div className="flex items-center space-x-4 ml-4">
            ...
            <button
              ...
              className="flex items-center bg-white border-1 rounded px-4 py-2 shadow-lg space-x-1 text-sm text-gray-600 hover:text-gray-800 cursor-pointer transition-colors"
            >
              <span>{language === 'en' ? 'বাং' : 'EN'}</span>
              <svg className="hidden md:block" width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
